...
| 10 — Exportación de reportes a PDF | Endpoint(s) de PDF server-side con plantilla propia (QuestPDF) para reportes branded/reproducibles | *(solo lectura)* | §8 | 9 | Pendiente |
