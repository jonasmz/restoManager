...
| [1 — Auth y usuarios](roadmap/fase-01-auth.md) | Auth API (Identity, JWT asimétrico, JWKS) + validación en Business API + login en el frontend | *(ASP.NET Identity, base `resto_identity`)* | [`auth.md`](auth.md) | 0 | En curso — 1a: Auth API (PR #3) · 1b/1c pendientes |
