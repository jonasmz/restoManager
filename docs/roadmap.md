...
| [8 — Clientes y fidelización](roadmap/fase-08-clientes-fidelizacion.md) | Clientes, puntos de fidelidad, gift cards (emisión/canje), reseñas | `customers`, `reviews`, `gift_cards`, `gift_card_transactions` | §3, CUS-*, §3.3 | 6 | Backend hecho (PR #22). Fidelidad: 1 pt/unidad al cerrar, canje 100 pts = 1 unidad (`Loyalty:RedeemRate`); gift cards con `customer_id` obligatorio y sin recarga; sin entidades anónimas. Pendiente frontend |
